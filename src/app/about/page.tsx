...
const values = [
  {
    ...
    description: "We believe in the power of bringing people together through meaningful events.",
  },
  {
    title: "Quality Experiences",
    description: "Every event on our platform is vetted to ensure it provides value to attendees.",
  },
  {
    title: "Accessibility",
    description: "We strive to make events accessible to everyone, regardless of background.",
  },
  {
    title: "Innovation",
    description: "We continuously improve our platform to better serve event organizers and attendees.",
  },
];
      ...
      <main className="flex-1 flex flex-col space-y-16">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-6 text-black">About Eventify</h1>
            <p className="text-xl mx-auto text-black font-semibold">
              We're on a mission to connect people through memorable events and experiences.
            </p>
          </div>
        </section>
        ...
        <section className="bg-[#172B4D] py-16">
          <div className="container mx-auto px-4 max-w-6xl grid md:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h2 className="text-3xl font-bold mb-6 text-center md:text-left">Our Story</h2>
              <p className="mb-4">
                Eventify was founded in 2020 with a simple idea: make it easier for people to discover and attend events they'll love.
              </p>
              <p className="mb-4">
                What started as a small platform for local events has grown into a comprehensive event marketplace
                serving thousands of event organizers and attendees across the country.
              </p>
              <p>
                Our platform helps event organizers reach their target audience while providing attendees with a
                seamless experience from discovery to attendance.
              </p>
            </div>
              ...
              {teamMembers.map((member, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-primary font-medium mb-3 text-black">{member.role}</p>
        ...
        <section className="bg-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-black">
              Join thousands of people who use Eventify to find and attend events they love.
            </p>
            <Link
              href="/events"
