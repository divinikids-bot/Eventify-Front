...
export interface EventData {
  ...
  hargaEvent?: number;
  kategori: 'MUSIC' | 'SPORTS' | 'FOOD' | 'BEAUTY';
  imageUrl?: string;
...
export const dummyEvents: EventData[] = [
  ...
  {
    id: "event-003",
    namaEvent: "Pameran Kuliner Yogyakarta",
  ...
  {
    id: "event-005",
    namaEvent: "Speed Beauty Professionals Jakarta",
  ...
  {
    id: "event-006",
    namaEvent: "Seminar Perawatan Kulit Wajah",
  ...
  {
    id: "event-009",
    namaEvent: "Pameran Kuliner Nusantara",
